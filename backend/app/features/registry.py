...
_GROUPS = (
    ...
    _Group(
        ...
        "Chat execution",
        "/home",
        "conversation_tool_orchestrator",
        "implemented",
        ("owner_session", "bounded_tool_execution"),
        ("verified_tool_capable_local_model",),
        (
            "backend:test_conversation_generation",
            "backend:test_filesystem_tool",
            "web:authenticated_chat_tool_e2e",
            "backend:real_chat_tool_smoke",
            "web:chat_execution_state",
        ),
        _features(
            ("structured_tool_selection", "Structured chat tool selection"),
            ("real_tool_result_loop", "Real tool result continuation"),
            ("tool_read_back_verification", "Independent tool read-back verification"),
            ("truthful_tool_failure", "Truthful blocked and failed tool state"),
        ),
    ),
    _Group(
        "ai_presence",
    ...
    _Group(
        ...
        "Owner checkpoints",
        "/missions",
        "persistent_agent_scheduler",
        "implemented",
        ("owner_session",),
        ("postgresql",),
        (
            "backend:test_agent_os_api",
            "backend:test_agent_missions_postgres",
            "web:agent_panel",
            "mobile:agents",
        ),
        _features(
    ...
    _Group(
        ...
        _features(
            ...
            ("ai_teacher", "Private AI teacher and tutor"),
            ("personalized_learning_plans", "Personalized learning plans"),
            ("course_generation", "Course and curriculum generation"),
            ("subject_aware_teaching", "Subject-aware teaching"),
            ("socratic_teaching", "Socratic teaching mode"),
            ("step_by_step_explanations", "Step-by-step explanations"),
            ("progressive_hints", "Progressive hint system"),
            ("worked_examples", "Worked and guided examples"),
            ("practice_question_generation", "Practice-question generation"),
            ("coding_tutor", "Coding tutor and pair-programming mode"),
            ("mathematics_tutor", "Mathematics tutor"),
            ("science_tutor", "Science tutor"),
            ("business_finance_learning", "Business and finance learning"),
            ("exam_preparation", "Exam preparation"),
            ("interview_preparation", "Interview preparation"),
            ("certification_preparation", "Certification preparation"),
            ("learner_profile", "Owner-scoped learner profile"),
            ("teaching_preferences", "Persistent teaching preferences"),
            ("learning_memory", "Learning context and history"),
            ("resumable_study_sessions", "Pause, resume and recover study sessions"),
        ),
    ),
    _Group(
        "universal_workspace",
        "Learning assessment and mastery",
        "/workspaces/learning",
        "learning_program_service",
        "implemented",
        ("owner_session",),
        ("database", "verified_local_model"),
        (
            "backend:test_learning_os",
            "backend:test_learning_postgres",
            "web:learning_panel",
            "mobile:studio",
        ),
        _features(
            ...
            ("short_answer_assessment", "Short-answer assessment"),
            ("long_answer_assessment", "Long-answer assessment"),
            ("continuous_assessment", "Continuous assessment"),
            ("quiz_generation", "Verified local quiz generation"),
            ("quiz_grading", "Quiz grading"),
            ("assignment_generation", "Assignment generation"),
            ("assignment_review", "Assignment review"),
            ("rubric_evaluation", "Deterministic rubric evaluation"),
            ("mistake_analysis", "Mistake classification and analysis"),
            ("skill_mastery", "Skill mastery scoring"),
            ("confidence_estimation", "Evidence-count confidence estimation"),
            ("weak_topic_detection", "Weak-topic detection"),
            ("knowledge_gap_detection", "Knowledge-gap detection"),
            ("adaptive_recommendations", "Personalized revision recommendations"),
            ("learning_analytics", "Learning analytics"),
            ("teacher_feedback_loop", "Attempt-to-teaching feedback loop"),
        ),
    ),
    _Group(
        "universal_workspace",
        "Learning knowledge grounding",
        "/workspaces/learning",
        "learning_program_service",
        "implemented",
        ("owner_session", "asset_access", "rag_read"),
        ("database", "ingested_owner_document", "verified_local_model"),
        (
            "backend:test_learning_grounding",
            "backend:test_learning_postgres",
            "web:learning_panel",
        ),
        _features(
            ("document_to_course", "Private document-to-course conversion"),
            ("document_to_quiz", "Private document-to-quiz conversion"),
            ("rag_based_teaching", "RAG-based teaching over owner documents"),
            ("source_grounded_teaching", "Source-grounded educational answers"),
            ("learning_citation_tracking", "Learning citation and source tracking"),
            ("source_uncertainty", "Insufficient-source and uncertainty handling"),
            ("source_terminology_preservation", "Source terminology preservation"),
            ("learning_prompt_injection_defense", "Document prompt-injection containment"),
            ("personal_knowledge_learning", "Personal knowledge-base learning"),
            ("learning_notes", "Knowledge notes and review cards"),
            ("learning_summaries", "Lesson summaries"),
            ("concept_map_learning", "Concept-map teaching prompts"),
            ("learning_timeline", "Audited learning timeline"),
            ("transcript_to_learning", "Ingested transcript-to-learning conversion"),
        ),
    ),
    _Group(
        "universal_workspace",
        "Learning modes and language",
        "/workspaces/learning",
        "learning_program_service",
        "implemented",
        ("owner_session",),
        ("verified_local_model", "database"),
        ("backend:test_learning_os", "web:learning_panel", "mobile:studio"),
        _features(
            ("study_mode", "Study-session mode"),
            ("focus_mode", "Focus mode"),
            ("learning_exam_mode", "Exam mode"),
            ("learning_revision_mode", "Revision mode"),
            ("learning_teacher_mode", "Teacher mode"),
            ("learning_coach_mode", "Coach mode"),
            ("learning_mentor_mode", "Mentor mode"),
            ("learning_interviewer_mode", "Interviewer mode"),
            ("pair_programming_mode", "Pair-programming teaching mode"),
            ("mixed_language_teaching", "Mixed-language and Hinglish teaching"),
            ("translation_assisted_learning", "Translation-assisted learning"),
            ("reading_comprehension", "Reading comprehension"),
            ("writing_improvement", "Writing improvement"),
            ("vocabulary_training", "Vocabulary training"),
            ("grammar_training", "Grammar training"),
            ("daily_learning_plan", "Daily learning plan"),
            ("weekly_learning_plan", "Weekly learning plan"),
            ("long_term_learning_goals", "Long-term learning goals"),
            ("learning_streaks", "Learning streak tracking"),
            ("educational_safety", "Educational uncertainty and safety boundaries"),
            ("learning_auditability", "Hash-only audit of learning state changes"),
        ),
    ),
    _Group(
        "universal_workspace",
        ...
        _features(
            ...
            ("flashcards", "Private flashcards"),
            ("active_recall", "Active recall"),
            ("revision_scheduler", "Revision scheduling"),
            ("automatic_revision_recommendations", "Automatic revision recommendations"),
        ),
    ),
    _Group(
        "universal_workspace",
    ...
    _Group(
        ...
        _features(
            ...
            ("filesystem_write", "Owner workspace file write"),
            ("filesystem_read", "Owner workspace file read"),
            ("filesystem_exists", "Owner workspace existence check"),
            ("filesystem_list", "Owner workspace directory list"),
            ("filesystem_stat", "Owner workspace file metadata"),
