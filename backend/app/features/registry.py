...
_GROUPS = (
    ...
    _Group(
        ...
        "learning_agent",
        "implemented",
        ("owner_session", "memory_read"),
        ("verified_local_model",),
        ("contract:feature_registry", "agent:planner_verifier"),
        _features(
    ...
    _Group(
        ...
        "Learning services",
        "/workspaces/learning",
        "external_learning_connector",
        "external_dependency",
        ("owner_session", "microphone"),
        ("pronunciation_scoring_provider", "spaced_repetition_store"),
        ("contract:feature_registry", "manual:external_boundary"),
        _features(
            ("pronunciation_scoring", "Pronunciation scoring"),
    ...
    _Group(
        ...
        "marketing_agent",
        "implemented",
        ("owner_session", "network_research"),
        ("verified_local_model",),
        ("contract:feature_registry", "agent:research_verifier"),
        _features(
    ...
    _Group(
        ...
        "implemented",
        ("owner_session", "network_research"),
        ("verified_local_model", "configured_data_source"),
        ("contract:feature_registry", "agent:data_verifier"),
        _features(
    ...
    _Group(
        ...
        "Market operations",
        "/workspaces/finance",
        "market_workspace_roadmap",
        "planned",
        ("owner_session",),
        ("market_workspace_persistence_and_simulation",),
        ("contract:feature_registry", "manual:documented_gap"),
        _features(
