...
The owner-sideload Windows artifacts are unsigned. Trusted publisher signing,
macOS packaging/notarization, and auto-update signing require owner-controlled
platform certificates or a macOS host and are not generated by the repository.
