...
export class ApiClient {
  ...
  getConnectorSettings(signal?: AbortSignal): Promise<ConnectorSettings> {
    return this.#request("api/v1/connectors/settings", {
      signal,
      decode: parseConnectorSettings,
    });
  }
  ...
  updateConnector(
    ...
    return this.#request(`api/v1/connectors/${encodeURIComponent(connectorId)}`, {
      method: "PUT",
      body: request,
      signal,
      decode: parseConnector,
  ...
  executeConnector(
    ...
    return this.#request(
      ...
      { method: "POST", body: request, signal, decode: parseConnectorExecutionResult },
    );
  }
  ...
  listMarketingCampaigns(signal?: AbortSignal): Promise<MarketingCampaignPage> {
    return this.#request("api/v1/marketing/campaigns", {
      signal,
      decode: parseMarketingCampaignPage,
    });
  }
  ...
  createMarketingCampaign(
    ...
    return this.#request("api/v1/marketing/campaigns", {
      method: "POST", body: request, signal, decode: parseMarketingCampaign,
    });
  }
  ...
  getMarketingCampaign(id: string, signal?: AbortSignal): Promise<MarketingCampaign> {
    return this.#request(`api/v1/marketing/campaigns/${encodeURIComponent(id)}`, {
      signal, decode: parseMarketingCampaign,
    });
  }

  startMarketingCampaign(id: string, signal?: AbortSignal): Promise<MarketingCampaign> {
    return this.#request(`api/v1/marketing/campaigns/${encodeURIComponent(id)}/start`, {
      method: "POST", signal, decode: parseMarketingCampaign,
    });
  }

  approveMarketingCampaign(id: string, signal?: AbortSignal): Promise<MarketingCampaign> {
    return this.#request(`api/v1/marketing/campaigns/${encodeURIComponent(id)}/approve`, {
      method: "POST", signal, decode: parseMarketingCampaign,
    });
  }
  ...
  submitMarketingAnalytics(
    ...
    return this.#request(`api/v1/marketing/campaigns/${encodeURIComponent(id)}/analytics`, {
      method: "POST", body: request, signal, decode: parseMarketingCampaign,
    });
  }
  ...
  getLearningCapabilities(signal?: AbortSignal): Promise<LearningCapabilities> {
    return this.#request("api/v1/learning/capabilities", {
      signal, decode: parseLearningCapabilities,
    });
  }

  listLearningPrograms(signal?: AbortSignal): Promise<LearningProgramPage> {
    return this.#request("api/v1/learning/programs", {
      signal, decode: parseLearningProgramPage,
    });
  }
  ...
  createLearningProgram(
    ...
    return this.#request("api/v1/learning/programs", {
      method: "POST", body: request, signal, decode: parseLearningProgram,
    });
  }

  getLearningProgram(id: string, signal?: AbortSignal): Promise<LearningProgram> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(id)}`, {
      signal, decode: parseLearningProgram,
    });
  }

  updateLearningProfile(programId: string, request: LearningProfileUpdateRequest, signal?: AbortSignal): Promise<LearningProgram> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/profile`, {
      method: "PUT", body: request, signal, decode: parseLearningProgram,
    });
  }
  ...
  generateLearningLesson(
    ...
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/lessons/${encodeURIComponent(lessonId)}/generate`, {
      method: "POST", signal, decode: parseLearningProgram,
    });
  }

  generateLearningAssessment(programId: string, lessonId: string, signal?: AbortSignal): Promise<LearningProgram> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/lessons/${encodeURIComponent(lessonId)}/assessment`, {
      method: "POST", signal, decode: parseLearningProgram,
    });
  }
  ...
  createLearningActivity(
    ...
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/lessons/${encodeURIComponent(lessonId)}/activities`, {
      method: "POST", body: request, signal, decode: parseLearningProgram,
    });
  }
  ...
  submitLearningAttempt(
    ...
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/activities/${encodeURIComponent(activityId)}/attempts`, {
      method: "POST", body: request, signal, decode: parseLearningAttempt,
    });
  }

  requestLearningHint(programId: string, activityId: string, signal?: AbortSignal): Promise<LearningHint> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/activities/${encodeURIComponent(activityId)}/hint`, {
      method: "POST", signal, decode: parseLearningHint,
    });
  }

  attachLearningSource(programId: string, documentId: string, signal?: AbortSignal): Promise<LearningProgram> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/sources`, {
      method: "POST", body: { document_id: documentId }, signal, decode: parseLearningProgram,
    });
  }

  detachLearningSource(programId: string, sourceId: string, signal?: AbortSignal): Promise<LearningProgram> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/sources/${encodeURIComponent(sourceId)}`, {
      method: "DELETE", signal, decode: parseLearningProgram,
    });
  }

  startLearningSession(programId: string, request: LearningSessionCreateRequest, signal?: AbortSignal): Promise<LearningSession> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/sessions`, {
      method: "POST", body: request, signal, decode: parseLearningSession,
    });
  }
  ...
  transitionLearningSession(programId: string, sessionId: string, action: "pause" | "resume" | "complete", signal?: AbortSignal): Promise<LearningSession> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/sessions/${encodeURIComponent(sessionId)}/${action}`, {
      method: "POST", signal, decode: parseLearningSession,
    });
  }

  getLearningAnalytics(programId: string, signal?: AbortSignal): Promise<LearningAnalytics> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/analytics`, {
      signal, decode: parseLearningAnalytics,
    });
  }

  getLearningStudyPlan(programId: string, days = 7, signal?: AbortSignal): Promise<LearningStudyPlan> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/study-plan?days=${days}`, {
      signal, decode: parseLearningStudyPlan,
    });
  }

  getLearningAudit(programId: string, signal?: AbortSignal): Promise<LearningEventPage> {
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/audit`, {
      signal, decode: parseLearningEventPage,
    });
  }
  ...
  createLearningReviewItem(
    ...
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/review-items`, {
      method: "POST", body: request, signal, decode: parseLearningReviewItem,
    });
  }
  ...
  reviewLearningItem(
    ...
    return this.#request(`api/v1/learning/programs/${encodeURIComponent(programId)}/review-items/${encodeURIComponent(itemId)}/reviews`, {
      method: "POST", body: request, signal, decode: parseLearningReviewItem,
    });
  }

  getCreativeCapabilities(signal?: AbortSignal): Promise<CreativeCapabilities> {
    return this.#request("api/v1/creative/capabilities", {
      signal, decode: parseCreativeCapabilities,
    });
  }

  listCreativeExperiences(signal?: AbortSignal): Promise<CreativeExperiencePage> {
    return this.#request("api/v1/creative/experiences", {
      signal, decode: parseCreativeExperiencePage,
    });
  }
  ...
  createCreativeExperience(
    ...
    return this.#request("api/v1/creative/experiences", {
      method: "POST", body: request, signal, decode: parseCreativeExperience,
    });
  }

  getCreativeExperience(id: string, signal?: AbortSignal): Promise<CreativeExperience> {
    return this.#request(`api/v1/creative/experiences/${encodeURIComponent(id)}`, {
      signal, decode: parseCreativeExperience,
    });
  }
  ...
  addCreativeTurn(
    ...
    return this.#request(`api/v1/creative/experiences/${encodeURIComponent(id)}/turns`, {
      method: "POST", body: request, signal, decode: parseCreativeExperience,
    });
  }

  completeCreativeExperience(id: string, signal?: AbortSignal): Promise<CreativeExperience> {
    return this.#request(`api/v1/creative/experiences/${encodeURIComponent(id)}/complete`, {
      method: "POST", signal, decode: parseCreativeExperience,
    });
  }
